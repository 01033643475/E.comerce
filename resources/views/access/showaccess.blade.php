...
<head>
    ...
    <title>{{ $access->name }} - Product Details</title>
    <!-- Google font -->
                                        ...
                                        <div class="cart-list">
                                            <div class="product-widget">
                                                <div class="product-img">
                                                    <img src="{{ $access->img }}" alt="">
                                                </div>
                                                <div class="product-body">
                                                    <h3 class="product-name"><a href="#">{{ $access->name }}</a>
                                                    </h3>
                                                    <h4 class="product-price"><span
                                                            class="qty">1x</span>${{ $access->price }}</h4>
                                                </div>
                                ...
                                <div class="product-widget">
                                    @foreach ($access as $item)
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h4 class="product-price"><span
                                                    class="qty">3x</span>${{ $access->price }}
                                            </h4>
                                        </div>
                                        <button class="delete"><i class="fa fa-close"></i></button>
                                    @endforeach
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li><a href="{{ url('accessphone') }}">accessphones</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="{{ $access->img }}" alt="{{ $access->name }}" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
                <!-- /Product main img -->
                ...
                <div class="col-md-6 product-details">
                    <h2 class="product-name">{{ $access->name }}</h2>
                    ...
                    <h3 class="product-price">${{ $access->price }} <del
                            class="product-old-price">${{ $access->discount }}</del></h3>
                    ...
                    <div class="add-to-cart">
                        ...
                        <h3 class="product-price">
                            Total Price: $<span id="total-price">{{ $access->price }}</span>
                        </h3>
                        <br>
