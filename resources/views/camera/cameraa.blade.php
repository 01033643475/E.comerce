        ...
        <tbody>
            @foreach ($camera as $post)
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="{{ url('camera/edit', $post->id) }}" role="button">Edit</a>
                        <a class="btn btn-danger" href="{{ url('camera/delete', $post->id) }}" role="button">delet</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
