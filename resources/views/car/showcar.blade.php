...
<head>
    ...
    <title>{{ $car->name }} - Product Details</title>
    <!-- Google font -->
                    ...
                    <div class="col-md-3">
                        <div class="header-logo">
                            <a href="{{ url('/') }}" class="logo">
                                ...
                                <h1 style="color: #eaeaea">Electro</h1>
                            </a>
                        </div>
                    </div>
                    <!-- /LOGO -->
                                        ...
                                        <div class="cart-list">
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    <h3 class="product-name"><a href="#">{{ $car->name }}</a>
                                                    </h3>
                                                    <h4 class="product-price"><span
                                                            class="qty">1x</span>${{ $car->price }}</h4>
                                                </div>
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li><a href="{{ url('carphone') }}">carphones</a></li>
                    <li><a href="{{ url('camera') }}">Cameras</a></li>
                    <li><a href="#">carories</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="{{ $car->img }}" alt="{{ $car->name }}" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
                <!-- /Product main img -->
                ...
                <div class="col-md-6 product-details">
                    <h2 class="product-name">{{ $car->name }}</h2>
                    ...
                    <h3 class="product-price">${{ $car->price }} <del
                            class="product-old-price">${{ $car->discount }}</del></h3>
                    ...
                    <div class="add-to-cart">
                        ...
                        <h3 class="product-price">
                            Total Price: $<span id="total-price">{{ $car->price }}</span>
                        </h3>
                        <br>
