...
<body>
    <div class="form-container">
        ...
        <form action="{{ url('laptop/insert') }}" method="post">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="price" class="form-control" placeholder="Enter price" inputmode="numeric"
                    required>
                <small class="form-text" style="color: blue;">Please enter numbers only.</small>
            </div>
            <div class="mb-3">
    ...
    <script>
        // منع المستخدم من إدخال غير الأرقام
        document.querySelector('input[name="price"]').addEventListener('input', function(e) {
            this.value = this.value.replace(/[^0-9]/g, '');
        });

        document.querySelector('input[name="discount"]').addEventListener('input', function(e) {
            this.value = this.value.replace(/[^0-9]/g, '');
        });
    </script>
</body>
