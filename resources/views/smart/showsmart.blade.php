...
<head>
    ...
    <title>{{ $smart->name }} - Product Details</title>
    <!-- Google font -->
                                        ...
                                        <div class="cart-list">
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    <h3 class="product-name"><a href="#">{{ $smart->name }}</a>
                                                    </h3>
                                                    <h4 class="product-price"><span
                                                            class="qty">1x</span>${{ $smart->price }}</h4>
                                                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="{{ $smart->img }}" alt="{{ $smart->name }}" class="img-fluid rounded">
                        </div>
                    </div>
                </div>
                <!-- /Product main img -->
                ...
                <div class="col-md-6 product-details">
                    <h2 class="product-name">{{ $smart->name }}</h2>
                    ...
                    <h3 class="product-price">${{ $smart->price }} <del
                            class="product-old-price">${{ $smart->discount }}</del></h3>
                    ...
                    <div class="add-to-cart">
                        ...
                        <h3 class="product-price">
                            Total Price: $<span id="total-price">{{ $smart->price }}</span>
                        </h3>
                        <br>
